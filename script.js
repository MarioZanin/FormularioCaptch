...
async function onClick(event) {
 ...
 const encodedMessage = encodeURIComponent(message);
  ...
  const confirmationUrl = `http://seusite.com/confirmar?name=${encodedName}&email=${encodedEmail}&address=${encodedAddress}&neighborhood=${encodedNeighborhood}&city=${encodedCity}&state=${encodedState}&phone=${encodedPhone}&message=${encodedMessage}&recaptchaToken=${recaptchaToken}`;
